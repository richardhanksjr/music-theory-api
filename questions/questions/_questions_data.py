...
tags = [{"name": "Interval", "questions": [SemitonesInInterval, IntervalRaisedLoweredIs, InvertedInterval, IntervalChangedByStepBecomesQuality]},
        {"name": "Interval Quality", "questions": [
            IntervalRaisedLoweredIs, IntervalChangedByStepBecomesQuality]},
        {"name": "Definitions", "questions": [SordinoMeans]},
        {"name": "Scale Degree Identification", "questions": [
            SimpleScaleDegreeMajor, SimpleScaleDegreeMinor]},
